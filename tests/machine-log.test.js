...
/**
 * Maschinen-Log (Einträge + per-Tab-KPE-Rendering)
 * Zusammengeführt in Issue #419 (Welle 3) aus:
 * 16-machine-log.test.js, 77-render-machine-log-per-tab-kpe.test.js
...
describe('Maschinen-Log (Einträge + per-Tab-KPE-Rendering) — übernommen aus 16-machine-log.test.js', () => {
/**
...
describe('Maschinen-Log (Einträge + per-Tab-KPE-Rendering) — übernommen aus 77-render-machine-log-per-tab-kpe.test.js', () => {
/**
