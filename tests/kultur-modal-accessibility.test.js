/**
 * Kultur-Dialoge: Accessibility (Fokus, Tab-Trap, Escape).
 *
 * 1. First-run-Modal (#kultur_modal) öffnet sich ohne explizite
 *    Fokus-Verlagerung in den Dialog hinein. Tastatur-User landeten
 *    auf einem außerhalb stehenden Element und konnten den Dialog nicht
 *    bedienen.
 * 2. Wechsel-Dialog (#kultur_confirm_modal) hatte denselben Defekt und
 *    bot zusätzlich keinen Escape-Pfad.
 ...
 *    den Wechsel nicht abbrechen, ohne Maus oder das ✕-Symbol zu nutzen.
 * 5. First-run-Modal darf Escape weiterhin NICHT schließen (das ist
 *    die verlangte Erzwingung der Erstauswahl).
 *
 * Frühere Datei: tests/80-kultur-modal-accessibility.test.js (Issue #419
 * Welle 1).
 */
