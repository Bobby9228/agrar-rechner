/**
 * Kultur-Persistenz + Cross-Tab-Sync.
 *
 * - Persistenz, Schema-Sanitizing, Reload und Cross-Tab-Sync für die
 *   neuen Felder `kultur` + per-Tab `koernerProEinheit`.
 * - storage-Event-Handler in render-tabs.js muss remote synchronisierte
 *   Kultur-State auch auf Badge, #koerner_empfehlung und First-run-Modal
 *   konsistent anwenden.
 *
 * Zugehörige frühere Dateien: tests/67-kultur-persistence.test.js,
 * tests/78-storage-event-kultur-sync.test.js (Issue #419 Welle 1).
 */
